...
\begin{table}[H]
  ...
  \label{tab:variables}
  \small
  \begin{tabularx}{\textwidth}{@{}p{1.9cm} p{2.0cm} X p{1.9cm} p{3.1cm}@{}}
    \toprule
    ...
    \texttt{log\_nikkei} & \texttt{LOG(STOCK\_IDX\_JP)} & Log of the Nikkei 225 index & Daily & LSEG Workspace \\
    \texttt{debtsec\_pct} & \texttt{DEBTSEC\_JP} & Net portfolio investment inflows to debt securities, percent of nominal GDP & Monthly to daily & Bank of Japan \\
