...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{@{}p{3.0cm} X p{3.0cm} p{1.6cm} p{2.8cm}@{}}
    ...
    \midrule
    \seqsplit{VIX.csv} & CBOE VIX volatility index, basis of the risk-off indicator & LSEG Workspace & Daily & Current \\
    \seqsplit{NIKKEI225.csv} & Nikkei 225 index & LSEG Workspace & Daily & Current \\
    \seqsplit{USDJPY.csv} & USD/JPY bilateral rate, end-of-month values convert flows to dollars & LSEG Workspace & Daily & Current \\
    \seqsplit{US10Y.csv} & 10-year US Treasury yield & LSEG Workspace & Daily & Current \\
    \seqsplit{jgbcme\_all.csv} & 10-year JGB yield, column 11 of the curve file & LSEG Workspace & Daily & Current \\
    \seqsplit{JAPAN\_RGDP.csv} & Constant-price real GDP, FRED series JPNRGDPEXP & FRED ALFRED, Federal Reserve Bank of St.\ Louis & Quarterly & As-of 2021-06-01 release \\
    \seqsplit{JAPAN\_NOMINAL\_GDP.csv} & Nominal GDP, FRED series JPNNGDP, denominator for flow shares & FRED, Federal Reserve Bank of St.\ Louis & Quarterly & Current \\
    \seqsplit{WUI\_JPN.csv} & World Uncertainty Index for Japan, FRED series WUIJPN & World Uncertainty Index database via FRED & Quarterly & Current \\
    \seqsplit{REER.xlsx} & Real effective exchange rate, broad index & BIS & Monthly & Wayback snapshot 2021-05-24 \\
    \seqsplit{BOJ\_6pi-1\_portfolio\_summary.csv} & Pre-2014 portfolio liability components & Bank of Japan BPM6 statistics & Monthly & Current \\
