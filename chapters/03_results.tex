...
Figure~\ref{fig:density_shift} overlays the two period distributions for each variable, with the dashed line marking the full-sample mean, and Figure~\ref{fig:density_full} pools all observations into a single density per variable. Together they document the dispersion shift that the variance tests quantify, the wider dispersion of the uncertainty index, the more negative location of the yield spread distribution, and the higher-amplitude capital flow distributions in the extension.
