...
crossval <- data.frame(
  ...
  mutate(Verdict = case_when(
    Verdict == "MATCH" ~ '<span style="color:#1DC9A4;font-weight:bold">MATCH</span>',
    Verdict == "PARTIAL" ~ '<span style="color:#F97A1F;font-weight:bold">PARTIAL</span>',
    TRUE ~ '<span style="color:#C91D42;font-weight:bold">MISMATCH</span>'))
crossval |>
  knitr::kable(caption = "Cross-validation of IRF values: replication versus published paper", escape = FALSE) |>
