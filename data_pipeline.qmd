...
ggplot(plot_data, aes(x = value, fill = period, color = period)) +
  ...
  geom_vline(aes(xintercept = full_mean),
    color = "#0D0D0D", linewidth = 0.3, linetype = "dashed") +
...
ggplot(ts_data, aes(x = date, y = value)) +
  geom_rect(aes(xmin = paper_end, xmax = max(date, na.rm = TRUE),
                ymin = -Inf, ymax = Inf),
            fill = "#F97A1F", alpha = 0.015, inherit.aes = FALSE) +
  ...
  labs(x = NULL, y = NULL, color = NULL,
       ...
       caption = "Shaded region: extended sample (April 2021 onward). Vertical line: paper period end (31 March 2021). Source: Authors\' calculations.") +
