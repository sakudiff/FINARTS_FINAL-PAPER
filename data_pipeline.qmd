...
defines the episodes. Every shaded band corresponds to a VIX spike exceeding
40, with peaks at roughly 80 during the global financial crisis in 2008 and
near 83 during the initial COVID outbreak in early 2020. The bilateral USD/JPY
...
consistency claim. On as-of-2026 data the two diverge. This divergence is visible
...
and the real effective exchange rate, the releases the original authors observed. The answer is yes, with one clean
...
the WUI response disagrees with the paper at both frequencies. Why this variable
...
and persistent. The unrestricted specification on as-of-2026 data
...
results diverge from the restricted specification on as-of-2026 data.
...
the restricted specification on as-of-2026 data, which contradicts the
