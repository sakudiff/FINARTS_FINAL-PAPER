...
Across the full set of variables, the extended period exhibits wider dispersion in capital flow series and economic policy uncertainty, while financial market variables (REER, equity index, yield spread) show tighter dispersion after 2021. The means reveal substantial shifts in several series: portfolio debt inflows as a share of GDP declined by 66 percent, while other investment inflows nearly tripled, consistent with the changing composition of cross-border flows under a different monetary policy regime. The real effective exchange rate and the stock index show level shifts of approximately 10 percent in opposite directions, reflecting yen depreciation and equity market appreciation respectively.
