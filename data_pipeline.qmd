...
85 during the initial COVID outbreak in early 2020. The bilateral USD/JPY
exchange rate panel shows the yen strengthening sharply during every risk-off
episode through 2020, dropping from 120 to roughly 75 between 2008 and 2011.
...
the dollar, and the REER falls from 80 to 50. This post-2021 divergence from
...
episode, from 5 percent in 2000 to 2.5 percent in 2008 to near zero in 2020.
...
sharply after 2023 to roughly 2.5 percent as the Bank of Japan began
normalising policy. The paper's argument that risk-off shocks widen the
...
index oscillates between 7,000 and 25,000 for two decades, collapsing during
each major risk-off episode, then surges nearly vertically after 2023 to
exceed 70,000. A market that spent 22 years recovering from its 1989 peak
doubled in three years. This is not a risk-off dynamic. It is a structural
...
the paper's stated method. The daily AIC declined monotonically through every
...
parameter rather than AIC's flat 2. The monthly BIC stabilises at lag 3.
Lag 3 matches the paper's monthly figures in Appendix 4 on sign, shape, and
peak timing. Lag 2 underfits and produces visibly smoother trajectories than
the publication shows. Lag 4 widens the confidence intervals and adds a
second oscillation that is not present in the paper's plots. Lag 3 is the
unique local minimum of the information criterion surface, not a boundary
artefact.
