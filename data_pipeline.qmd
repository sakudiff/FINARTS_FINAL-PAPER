...
#| echo: false
#| message: false
knitr::include_graphics("data/processed/var_results/figures/fig1_vix_risk_off.png")
```
...
#| echo: false
#| message: false
knitr::include_graphics("data/processed/var_results/figures/fig2_usdjpy_risk_off.png")
```
...
#| echo: false
#| message: false
knitr::include_graphics("data/processed/var_results/figures/fig3_reer_risk_off.png")
```
...
produce both. The analytical method (asymptotic normal approximation) is the
default in every major VAR package and is the most likely method the paper
used. The bootstrap method (residual-based, 100 replications) is added as a
