...
|----------|------------|-----------|-------------------|--------|
| `risk_off` | Risk-off event indicator: 1 when VIX is at least 10 points above its 60-day moving average | Daily | Bloomberg, LSEG |
| `spread` | Yield spread between 10-year JGB and 10-year US Treasury | Daily | Bloomberg, LSEG |
| `log_nikkei` | Log of Nikkei-225 stock index | Daily | Bloomberg, LSEG |
...
| `debtsec_pct` | Net portfolio investment inflows to debt securities (% of nominal GDP) | Monthly → daily (quadratic) | BOJ, IMF, Bloomberg, LSEG |
| `equity_pct` | Net portfolio investment inflows to equity (% of nominal GDP) | Monthly → daily (quadratic) | BOJ, IMF, Bloomberg, LSEG |
| `other_pct` | Net other investment inflows (% of nominal GDP) | Monthly → daily (quadratic) | BOJ, IMF, Bloomberg, LSEG |
| `direct_pct` | Net direct investment inflows (% of nominal GDP) | Monthly → daily (quadratic) | BOJ, IMF, Bloomberg, LSEG |
