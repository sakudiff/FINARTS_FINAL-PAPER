...
|--------|-------------|---------------|
| ADF tests | Stationarity test results for all 10 variables | `data/processed/var_results/adf_tests_*.csv` |
| Lag selection | AIC values for lags 1 through 20 | `data/processed/var_results/lag_selection_*.csv` |
| IRF figures | Impulse response to a one-standard-deviation Risk-off shock over 125 days, with analytical and bootstrap 95% CIs | `data/processed/var_results/figures/irf_*.png` |
| FEVD tables | Forecast error variance decomposition at 1, 5, 20, 60, and 125 days | `data/processed/var_results/fevd_*.csv` |
| IRF peak tables | Peak response magnitude and day for each variable | `data/processed/var_results/irf_peak_*.csv` |
| Period comparison | Overlay of restricted IRFs for 1999-2021 versus 1999-2026 | `data/processed/var_results/figures/irf_period_comparison_restricted.png` |
