...
The resolution is asymmetric. The daily tier retains AIC with maxlag 20 per
the paper's stated method, with no better alternative. The monthly tier uses
BIC with maxlag 12, returning lag 3 for both the paper period and the
extended sample. This decision is documented in the Design Decisions section
and cross-referenced as limitation L7.
