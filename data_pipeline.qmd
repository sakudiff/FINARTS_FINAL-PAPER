...
MATCH indicates the paper's qualitative conclusion reproduces (sign, shape, and timing agree; magnitude differences reflect software-variant shock scaling). PARTIAL indicates the overall direction or conclusion matches but a meaningful detail diverges (earlier trough, no initial blip, noisier trajectory). MISMATCH indicates the sign is opposite and no rescaling reconciles the result with the paper's published figure.
