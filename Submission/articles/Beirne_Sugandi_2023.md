...
Description of the figures for Japan

### **Figure A3.1: Real and Financial Spillovers in Japan**

This figure displays a 5-row by 2-column grid of impulse response functions. All ten subplots share a common horizontal x-axis, representing time periods, which ranges from 0 to 125, with major tick labels at 25, 50, 75, 100, and 125. Each subplot contains a central solid black line representing the point estimate and two dotted orange lines representing the upper and lower confidence intervals.

* **Top-Left Subplot:** Titled "Response of RISK to RISK Innovation". The vertical y-axis ranges from 0.00 to 0.10. The solid black line originates at approximately 0.10 at time 0, decays sharply and exponentially, asymptotically reaching 0 by time period 25. The dotted orange confidence intervals are very narrow and tightly hug the black line throughout the entire duration.
* **Top-Right Subplot:** Titled "Response of LOG(WUI_JP) to RISK Innovation". The y-axis ranges from 0.0000 to 0.0028, with tick marks every 0.0004. The black line starts at 0.0000, rises steeply in the initial periods, and asymptotically plateaus at approximately 0.0012. The upper dotted orange line rises prominently, reaching approximately 0.0025, while the lower dotted orange line remains just above the 0.0000 baseline.
* **Second Row, Left Subplot:** Titled "Response of SPREAD_JP to RISK Innovation". The y-axis ranges from -0.002 to 0.014, with ticks at 0.004 increments. The black line starts at 0, dips briefly to -0.001 around period 5, then rises to a peak of roughly 0.008 at period 25, before slowly decaying to approximately 0.005 by period 125. The dotted orange lines form a wide, fanning confidence band.
* **Second Row, Right Subplot:** Titled "Response of LOG(RGDP_JP) to RISK Innovation". The y-axis ranges from -0.0008 to 0.0000, with ticks at 0.0002 increments. The black line starts at 0, drops steadily to a trough of -0.0005 by period 50, and then slowly recovers, reaching -0.0003 by the end of the horizon. Both dotted orange lines remain below the zero line.
* **Third Row, Left Subplot:** Titled "Response of LOG(REER_JP) to RISK Innovation". The y-axis ranges from 0.0000 to 0.0014, with ticks every 0.0002. The black line begins at 0, rises to approximately 0.0007, and flatlines. The dotted orange lines fan out, with the upper line reaching 0.0012 and the lower line reaching 0.0002.
* **Third Row, Right Subplot:** Titled "Response of LOG(STOCK_IDX_JP) to RISK Innovation". The y-axis spans from -0.002 to 0.002, with ticks at 0.001 intervals. The black line drops sharply to -0.001 immediately, rebounds back to 0 by period 25, and remains flat. The dotted orange lines form a wide band.
* **Fourth Row, Left Subplot:** Titled "Response of DEBTSEC_JP to RISK Innovation". The y-axis ranges from -0.010 to 0.005. The black line starts at 0, dips to -0.002, and hovers around -0.001 for the remainder of the period. The dotted intervals are predominantly situated in the negative region.
* **Fourth Row, Right Subplot:** Titled "Response of EQUITY_JP to RISK Innovation". The y-axis ranges from -0.012 to 0.004, with ticks at 0.004 increments. The black line drops to a trough of -0.004 and then gradually rises back towards 0.
* **Fifth Row, Left Subplot:** Titled "Response of OTHER_JP to RISK Innovation". The y-axis spans -0.010 to 0.020, with ticks at 0.010 increments. The black line dips to -0.005, then steadily climbs to a peak of 0.010 at period 50, before decaying back towards 0.005. The dotted confidence intervals are exceptionally wide.
* **Fifth Row, Right Subplot:** Titled "Response of DIRECT_JP to RISK Innovation". The y-axis ranges from -0.004 to 0.003. The black line drops to -0.002 initially, then rises and plateaus at approximately 0.001.

### **Figure A2.1: Real and Financial Spillovers in Japan**

This figure is visually identical in layout and structure to Figure A3.1, featuring the same 5-row by 2-column grid. The titles, the x-axis range (0 to 125 with ticks at 25, 50, 75, 100, 125), and the y-axis ranges for every subplot exactly match those in A3.1. The behavior of the solid black central lines and the dotted orange confidence intervals depicts the exact same trajectories, peaks, troughs, and asymptotic behaviors as described in Figure A3.1, though the confidence intervals may exhibit marginal width differences that are indistinguishable at this resolution.

### **Figure Comparisons by Frequency (Daily, Weekly, Monthly)**

The subsequent figures break down the impulse responses for specific variables into three panels: Daily (top), Weekly (middle), and Monthly (bottom). Note that the Daily panels use an x-axis from 0 to 125, while the Weekly and Monthly panels use an x-axis from 0 to 40 (with major tick marks at 5, 10, 15, 20, 25, 30, 35, and 40).

**Response of LOG(WUI_JP) to RISK Innovation (Image 3)**

* **Daily (Top):** The y-axis ranges from 0.0000 to 0.0035, with ticks every 0.0005. The black line rises from 0 to plateau at 0.0015. The upper dotted orange line reaches 0.003, and the lower line remains flat at 0.
* **Weekly (Middle):** The y-axis ranges from 0.000 to 0.008. The black line rises more steeply, reaching a plateau of 0.0045. The upper dotted line peaks at 0.007, while the lower line stays near 0.
* **Monthly (Bottom):** The y-axis ranges from -0.10 to 0.20, with ticks every 0.05. The black line behaves differently, dropping to -0.05 initially, then recovering to a plateau of -0.02. The upper dotted line rises to 0.15, and the lower line drops to -0.15.

**Response of LOG(RGDP_JP) to RISK Innovation (Image 4)**

* **Daily (Top):** The y-axis ranges from -0.0010 to 0.0000. The black line drops to -0.0005 and then slowly recovers. Both dotted lines remain in the negative territory.
* **Weekly (Middle):** The y-axis ranges from -0.028 to 0.000, with ticks every 0.004. The black line drops sharply to a trough of -0.016 and then rises to -0.008.
* **Monthly (Bottom):** The y-axis ranges from -0.08 to 0.02. The black line drops to -0.02, then recovers slightly to -0.01.

**Response of LOG(REER_JP) to RISK Innovation (Image 5)**

* **Daily (Top):** The y-axis ranges from 0.0000 to 0.0016. The black line rises from 0 and plateaus at roughly 0.0008.
* **Weekly (Middle):** The y-axis ranges from -0.04 to 0.04. The black line rises to a peak of 0.02 at period 10, then slowly declines to 0.01 by period 40.
* **Monthly (Bottom):** The y-axis ranges from -0.04 to 0.04. The black line drops from 0 to -0.02 and continues a gradual decline, reaching -0.03. The confidence intervals are exceptionally wide.

**Response of LOG(STOCK_IDX_JP) to RISK Innovation (Image 6)**

* **Daily (Top):** The y-axis ranges from -0.002 to 0.002, with ticks at 0.001. The black line drops to -0.001, then rapidly recovers to 0.
* **Weekly (Middle):** The y-axis ranges from -0.12 to 0.04. The black line drops to a trough of -0.02, then rises back to 0.
* **Monthly (Bottom):** The y-axis ranges from -0.15 to 0.10. The black line drops to -0.03 initially, then steadily rises, crossing above zero to reach 0.05 by period 40.

**Figure A4.4: Sovereign Bond Spreads in Safe (Image 7)**

* **Daily (Top):** Titled "Response of SPREAD_JP to RISK Innovation". The x-axis is 0 to 125. The y-axis ranges from -0.004 to 0.016. The black line rises to a peak of 0.009 at period 50, then slowly decays to 0.006.
* **Weekly (Middle):** The x-axis is 0 to 40. The y-axis ranges from -0.04 to 0.04. The black line rises to a peak of 0.018, then declines to 0.012.
* **Monthly (Bottom):** The x-axis is 0 to 40. The y-axis ranges from -0.04 to 0.12. The black line spikes rapidly to 0.08, then sharply declines towards 0.02.

**Response of DEBTSEC_JP to RISK Innovation (Image 8)**

* **Daily (Top):** The y-axis ranges from -0.015 to 0.015. The black line dips slightly to -0.002 and then recovers to 0.
* **Weekly (Middle):** The y-axis ranges from -0.04 to 0.04. The black line rises to a peak of 0.02, then gradually decays to 0.01.
* **Monthly (Bottom):** The y-axis ranges from -0.05 to 0.10. The black line exhibits a sharp initial spike to 0.04, then drops to 0 and oscillates slightly around the zero line for the remaining periods.

**Response of EQUITY_JP to RISK Innovation (Image 9)**

* **Daily (Top):** The y-axis ranges from -0.015 to 0.005. The black line drops to -0.005, then gradually rises back to 0.
* **Weekly (Middle):** The y-axis ranges from -0.12 to 0.04. The black line drops to a trough of -0.02, then slowly recovers to -0.01.
* **Monthly (Bottom):** The y-axis ranges from -0.20 to 0.10. The black line drops steeply to a deep trough of -0.09, then sharply rebounds to a peak of 0.02, before gradually decaying to 0.01 by period 40.
